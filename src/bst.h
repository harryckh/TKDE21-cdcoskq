...
typedef struct bst_node
{
	...
	W_TYPE*				p_list_weight;	//IR-tree with weight for each children
	W_TYPE				min_weight;		//IR-tree with min weight among the children
...
void print_bst_node(bst_node_t* bst_node_v);
